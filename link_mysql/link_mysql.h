#ifndef __LINK_MYSQL_H__
#define __LINK_MYSQL_H__
...
public:
    ...
    int field_cout,int row_no)> data_cb;
...
public:
    ...
    socks::IStmt::ptr prepare(const std::string& sql) override;
